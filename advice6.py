...
def get_current_price(ticker, api_key="0K6C6YK8DzNT24RZg5xHMDrLjIyRjpb7"):
    """
...
def get_fundamental_score(ticker, api_key="0K6C6YK8DzNT24RZg5xHMDrLjIyRjpb7"):
    """
...
def evaluate_stock_for_trade(current_price, market_cap, day_high, day_low, price_avg50, price_avg200):
    ...
    if current_price > price_avg50:
        print(f"Price is above the 50-day moving average ({price_avg50}). Bullish signal.")
    else:
        recommendation = "Sell"
        print(f"Price is below the 50-day moving average ({price_avg50}). Bearish signal.")
    
    if current_price > price_avg200:
        print(f"Price is above the 200-day moving average ({price_avg200}). Long-term bullish trend.")
    else:
        recommendation = "Sell"
        print(f"Price is below the 200-day moving average ({price_avg200}). Long-term bearish trend.")
...
def main():
    ...
    api_key = "0K6C6YK8DzNT24RZg5xHMDrLjIyRjpb7"  # Replace with your API key if needed
